...
class _ImageUploadState extends State<ImageUpload>
  ...
  late Future<dynamic> fileUpload;
  ...
  selectFile() async {
    ...
    if (file != null) {
      setState(() {
        ...
        fileUpload = APIService().uploadImage(_file);
      });
    }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MaterialButton(
                          ...
                          height: 45,
                          onPressed: () {
                            APIService().uploadImage(_file!);
                            //print(fileUpload);
                            // APIService().uploadImage3(_file, EndPoint.documentUpload2);
                          },
                          color: Colors.black,
                          child: const Text(
                            'Upload',
